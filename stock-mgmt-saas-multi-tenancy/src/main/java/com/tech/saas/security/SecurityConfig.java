...
public class SecurityConfig {
     ...
     * servlet filter. Without this, the filter runs twice:
     * 1. As a regular servlet filter (outside Spring Security chain) → sets auth
     * 2. SecurityContextHolderFilter clears the context
     * 3. OncePerRequestFilter skips the second run inside the Security chain → 403 for all
     */
    @Bean
